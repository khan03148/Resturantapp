                ...
                <div className="row row-content">
                    ...
                    <FormGroup row>
                        <Col md={{size:6, offset:2}}>
                          ...
                          <Input type="select" name="contactype" value="{this.state.contactType} onChange={this.handleInput}">
                              <option>Tel.</option>
                              <option>Email</option>
                          </Input>
                        ...
                        <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="textarea" id="message" name="message" row="12"
                        ...
                        <FormGroup>
                                <Col md={{size:10,offset:2}}>
                                    <Button type="submit" colour="primary">Send Feedback</Button>
                                </Col>
                        </FormGroup>
                    </Form>
                    </div>
